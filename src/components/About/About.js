    ...
    return (
        <div className="text-container">
            ...
            <div className="uni-list">
                ...
                <ul>
                    <li>I was in the <a href="https://tech4good.soe.ucsc.edu/#/">Tech4Good lab</a> for 2 years, where I studied web development, research and design. I was a lab fellow for one year.</li>
                    <li>I did an internship at American Express working on a salesforce recruitment app.</li>
                    <li>I tutored for the <a href="https://courses.soe.ucsc.edu/courses/cmps5j">Intro to Programming in Java</a> and <a href="https://courses.soe.ucsc.edu/courses/tim158">Business Strategy and Information Systems</a> classes.</li>
                    <li>I was the Outreach Chair for the <a href="https://swe.org/">Society of Women Engineers,</a> where I led a committee organize engineering classes for local youth.</li>
                </ul>
            </div>
